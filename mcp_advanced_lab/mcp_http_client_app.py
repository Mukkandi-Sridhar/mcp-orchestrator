...
class MCPHTTPClientApp(MCPHTTPClient):
   ...
   async def gui_call_tool(self, tool_name, arguments_json):
       ...
       try:
           ...
           output = ""
           # Handle tool results (usually in result.content)
   ...
   async def gui_list_resources(self):
       ...
       if resources:
           ...
           for r in resources:
               ...
               uri_template = getattr(r, 'uriTemplate', getattr(r, 'uri', 'Unknown URI'))
   ...
   async def gui_read_resource(self, uri):
       ...
       try:
           ...
           output = ""
           # Resource results use result.contents
   ...
   async def gui_get_prompt(self, prompt_name, arguments_json):
       ...
       try:
           ...
           for msg in result.messages:
               # msg.content is typically a message content object with a .text attribute
   ...
   def create_interface(self):
       ...
       with gr.Blocks(title="MCP HTTP Client") as interface:
           ...
           **Workspace Roots:** {self.roots_dir}
           ...
           All file operations are restricted to the workspace roots directory for security.
           """)
           ...
           with gr.Tabs():
               with gr.Tab("Tools"):
                   ...
                   with gr.Row():
                       ...
                       with gr.Column():
                           tool_dropdown = gr.Dropdown(label="Select Tool")
               ...
               with gr.Tab("Prompts"):
                   ...
                   with gr.Row():
                       with gr.Column():
                           ...
                           prompts_output = gr.Textbox(label="Available Prompts", lines=10)
                       with gr.Column():
                           prompt_dropdown = gr.Dropdown(label="Select Prompt")
                           ...
                           prompt_result = gr.Textbox(label="Prompt Messages", lines=15)
...
def main():
   if len(sys.argv) < 3:
       ...
       print("Example: python mcp_http_client_app.py http://127.0.0.1:8000 workspace")
       sys.exit(1)
